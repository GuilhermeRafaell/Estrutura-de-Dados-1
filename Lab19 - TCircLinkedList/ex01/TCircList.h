...
int list_push_front(CircList *c, aluno al);

int list_push_back(CircList *c, aluno al);
...
int list_find_pos(CircList *c, int pos, aluno *al);

int list_find_mat(CircList *c, int mat, aluno *al);

int list_front(CircList *c, aluno *al);

int list_back(CircList *c, aluno *al);
